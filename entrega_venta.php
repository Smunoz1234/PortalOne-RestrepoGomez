...
<?php foreach ($array_Dimensiones as &$dim) {?>
	...
	<?php $Name_IdDoc = "ID_EntregaVenta";?>
	...
	$("#<?php echo $dim['IdPortalOne']; ?>").change(function() {
		...
		var docType = 3;
		var detalleDoc = "detalle_entrega_venta.php";
						...
						<div class="col-lg-6">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<?php $SQL_Formato = Seleccionar('uvw_tbl_FormatosSAP', '*', "ID_Objeto=15 AND (IdFormato='" . ($row['IdSeries'] ?? -1) . "') AND VerEnDocumento='Y' AND (EsBorrador='N' OR EsBorrador IS NULL)");?>
			   ...
			   <form id="frm" action="" class="form-horizontal">
				...
				<div class="col-lg-8">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<textarea name="Comentarios" form="CrearEntregaVenta" maxlength="2000" rows="4" class="form-control" id="Comentarios" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {echo "readonly";}?>><?php if ($edit == 1 || $sw_error == 1) {echo $row['Comentarios'];} elseif (isset($_GET['Comentarios'])) {echo base64_decode($_GET['Comentarios']);}?></textarea>
						</div>
					</div>
