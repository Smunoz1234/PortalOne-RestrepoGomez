...
<head>
	...
	<title>Consultar lista de materiales |
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<form action="consultar_lista_materiales.php" method="get" id="formBuscar"
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<input name="BuscarDato" type="text" class="form-control" id="BuscarDato"
											maxlength="100" placeholder="Consulte el ID o cualquier dato de la lista"
										...
										<tbody>
											<?php while ($row = sqlsrv_fetch_array($SQL)) { ?>
												<tr class="gradeX">
													...
													<td>
														<?php echo $row['CDU_NombreCliente']; ?>
													</td>
													<td>
														<?php echo $row['CDU_SucursalCliente']; ?>
													</td>
													<td><a href="lista_materiales.php?id=<?php echo base64_encode($row['ItemCode']); ?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('consultar_lista_materiales.php'); ?>"
