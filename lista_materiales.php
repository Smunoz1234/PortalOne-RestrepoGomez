...
while ($row_Plantilla = sqlsrv_fetch_array($SQL_Plantilla)) {?>
				...
				<div class="form-group">
					...
					<div class="col-lg-3">
						<textarea name="CDU_MetodoAplicacion" rows="5" class="form-control" id="CDU_MetodoAplicacion" type="text"><?php if (($edit == 1) || ($sw_error == 1)) {echo $row['CDU_MetodoAplicacion'];}?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<label class="col-lg-1 control-label">Tiempo tarea (Minutos) <span class="text-danger">*</span></label>
					<div class="col-lg-3">
