						...
						<div class="col-lg-12">
							<form action="lista_materiales.php" method="post" class="form-horizontal"
								...
								<div class="form-group">
									...
									<div class="col-lg-4">
										<label class="control-label">Tiempo tarea (Minutos) <span
												class="text-danger">*</span></label>
								...
								<div class="form-group">
									<label class="col-lg-1 control-label">MARCA <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<select name="CDU_IdMarca" class="form-control select2" required="required"
											id="CDU_IdMarca">
									...
									<label class="col-lg-1 control-label">LINEA <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<select name="CDU_IdLinea" class="form-control select2" required="required"
											id="CDU_IdLinea">
