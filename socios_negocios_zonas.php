...
<head>
	...
	<title>Zonas de socios de negocios |
								...
								<?php if ($sw == 1) { ?>
									...
									<div class="form-group">
										<iframe id="DataGrid" name="DataGrid" style="border: 0;" width="100%" height="700"
											src="detalle_zonas_sn.php?cardcode=<?php echo base64_encode($_GET['Cliente']); ?>&idsucursal=<?php echo base64_encode($_GET['Sucursal']); ?>&periodo=<?php echo base64_encode($Anno); ?>"></iframe>
									</div>
								<?php } ?>
							</form>
						</div>
