                    ...
                    <?php
						...
						while($row=sqlsrv_fetch_array($SQL)){ ?>
						 <tr class="gradeX">
							...
							<td><?php if($row['DocDestinoDocEntry']!=""){?><a href="<?php if($row['DocDestinoObjeto']==21){echo "devolucion_compra";}else{echo "factura_compra";}?>.php?id=<?php echo base64_encode($row['DocDestinoDocEntry']);?>&id_portal=<?php echo base64_encode($row['DocDestinoIdPortal']);?>&tl=1" target="_blank"><?php echo $row['DocDestinoDocNum'];?></a><?php }else{echo "--";}?></td>
